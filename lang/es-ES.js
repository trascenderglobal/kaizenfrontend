export default {
  ...
  settings: {
    ...
    subscribeWithCode: 'O puedes suscribirte usando un ',
    digits: 'código de {digits} dígitos',
    enterCode:
      'Por favor, ingresa tu código de {digits} dígitos para suscribirte',
    invalidCode: 'Por favor, ingresa un código de {digits} dígitos válido',
    subscribed: 'Tienes una suscripción de por vida en Kaizen Squad',
    insufficientFunds: 'Fondos insuficientes.',
    paymentError: 'No se pudo confirmar tu pago, intenta de nuevo.',
